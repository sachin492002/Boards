...
export default function Boards() {
    ...
    return(
        <div className='flex flex-col h-[100vh]'>
            ...
            <div className='bg-[var(--clr-primary-3)] w-full flex flex-col h-full'>
                <div className='inline-flex w-full justify-between items-center px-10 py-4'>
                    <p className='text-4xl'>Your Posts</p>
                    <div className='bg-[var(--clr-primary-1)] px-3 py-0.5 rounded-lg inline-flex items-center'>
                        <BsPlus className='text-white  text-4xl'/>
                        <button className='text-white leading-6'>
                            Create new post
                        </button>
                    </div>
                </div>
                {!board && <div className='flex flex-col justify-center h-full items-center'>
                         <div>
                             <img src='/empty.svg'/>
                         </div>
